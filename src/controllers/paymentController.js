...
/**
 * 2. VERIFY PAYMENT
 * Called BY Frontend (index.html or game.html)
 * index.html expects ONLY successful verification
 * game.html handles all other outcomes (failed/invalid)
 */
